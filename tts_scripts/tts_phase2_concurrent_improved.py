...
from datetime import datetime, timezone  # still used for report timestamp
...
def _worker_inference(
    ...
    # ── Absolute timestamps ───────────────────────────────────────────────────
    # datetime.now() gives wall-clock time in human-readable ISO format.
    # time.perf_counter() gives high-resolution elapsed time for duration calc.
